...
//app.use(express.static("public", { index: "revieworders.html" }));
app.use(express.static("public", { index: "adminpanel.html" }));
app.use('/', adminRoutes);

//app.locals.revieworder = require("./public/jsons/shivijsons/revieworder.json")
